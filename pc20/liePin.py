...
def main(i):
    url = 'https://www.liepin.com/zhaopin/?ckid=f85a7e2cdb27186c&fromSearchBtn=2&init=-1&sfrom=click-pc_homepage-centre_searchbox-search_new&degradeFlag=0&key='+keyWord[i%3]+'&headckid=f85a7e2cdb27186c&d_pageSize=40&siTag=I-7rQ0e90mv8a37po7dV3Q%7EfA9rXquZc5IkJpXC-Ycixw&d_headId=6b34de8295422a575511f372881718fa&d_ckId=6b34de8295422a575511f372881718fa&d_sfrom=search_fp&d_curPage='+str(i+1)+'&curPage='+str(i)
    ...
    soup = bs(res, 'lxml')
    string_handle(soup,keyWord[i%3])
